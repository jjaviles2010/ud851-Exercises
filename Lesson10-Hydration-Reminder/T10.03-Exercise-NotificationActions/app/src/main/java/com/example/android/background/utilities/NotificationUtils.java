...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 6969;

    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 964;
    ...
    //      COMPLETED (12) Create an Intent to launch WaterReminderIntentService
        Intent intentDrinkWater = new Intent(context, WaterReminderIntentService.class);
